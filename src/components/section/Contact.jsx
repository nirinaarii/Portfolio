...
export const Contact =() =>{
    ...
    // const SERVICE_ID = "service_jeex1co";
    // const TEMPLATE_ID = "template_hn5vfnw";
    // const PUBLIC_KEY = "RNFLP41StFg6N7vtI";
    const handleSubmit = (e)=>{
        ...
        .catch(()=> alert("Oops! Something went wrong. Please tr again."));
    };  
    return (
        <section
        id="contact"
            ...
            <RevealOnScroll>
                <div className="px-4 w-150">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="w-full bg-blue-500 text-white py-3 px6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] ">
                            Envoyer Message
                        </button>
                    </form>
                </div>
