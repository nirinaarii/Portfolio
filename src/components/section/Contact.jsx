...
export const Contact = () => {
  ...
  return (
    ...
    >
      <RevealOnScroll>
        <div className="w-[400px] max-w-full px-4 sm:px-6 lg:px-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {/* <input
              ...
              className="block w-full bg-white/10 border border-white/20 rounded-md px-5 py-3 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="Nom..."
            /> */}
            {/* <label for="input-group-1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Votre Email</label> */}
            <div class="relative mb-6">
              ...
              onChange={(e) => setFormData({ ...formData, email: e.target.value })}
               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="rakot@gmail.com" />
            </div>
